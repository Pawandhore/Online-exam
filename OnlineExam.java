...
class OnlineTestBegin extends JFrame implements ActionListener {
    ...
    void set() {
        ...
        if (current == 1) {
            l.setText("Que2: Number of primitive data types in python are?");
            jb[0].setText("6");
            jb[1].setText("7");
            jb[2].setText("8");
            jb[3].setText("9");
        ...
        if (current == 3) {
            l.setText("Que4: Expected created by  catch block is caaught in which block.?");
            jb[0].setText("catch");
            jb[1].setText("throw");
            jb[2].setText("final");
            jb[3].setText("thrown");
        ...
        if (current == 4) {
            l.setText("Que5: Which of the following is  an OOPS concept in java?");
        ...
        if (current == 7) {
            l.setText("Que8: What is the implict return type of method?");
        ...
        if (current == 9) {
            l.setText("Que10: Which provides runtime enviroment for python byte code to be executed?");
            jb[0].setText("JDK");
            jb[1].setText("JVM");
            jb[2].setText("JRE");
            jb[3].setText("JAVAC");
